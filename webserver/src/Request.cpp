...
/*   Updated: 2026/01/18 19:05:46 by tching           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string	Request::defaultFileCount() {																																				
	int i = 1;																																				
...
{																																					
	...
	if (end != std::string::npos) {																																				
		...
		if (space1 != std::string::npos || space2 != std::string::npos) {																																			
			...
			size_t	paramsFound = _path.find('?'); // find params in URL																																
...
void	Request::handleGetMethod(std::string &fileToOpen) {																																				
	...
	if (fileOrDirectory(fileToOpen)) {  // path is a directory																																				
		if (!_location.getReturn().empty()) {  // redirection found																																			
			std::map<int, std::string>	redirection = _location.getReturn();																																	
			if (redirection.find(301) != redirection.end()) {																																		
				_redirectionLocation = redirection[301];																																	
